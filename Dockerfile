...
RUN apk add --no-cache \
 ...
 autoconf automake libtool libxslt-static libxslt-dev patch bash tar
...
COPY build-ngx-addon.sh build-ngx-addon.sh
RUN chmod +x ./build-ngx-addon.sh
RUN bash ./build-ngx-addon.sh
